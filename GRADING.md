...
I address other miscellaneous grading questions in the [FAQ](#faq) at the bottom of this document. 
...
### Projects (45% of total course points)
...
### Exams (45% of total course points)
...
**1. Why are the online exams proctored? That's so stupid.**
...
I originally had a huge rant as an answer for this question. Notify me if you ever want to read it. 

**2. Are there exam statistics anywhere?**

Dr. Enbody will have them in his post-exam email.

**3. How did you prepare for CSE231 exams?**
...
**4. How did you do when you took this class?**
...
**6. Is using w3schools.com and/or programiz.com okay as supplementary material?**
...
**7. Do you use tabs or spaces?**

Tabs, I'm not tryna demolish my spacebar.

**8. Do you know any other programming languages?**
...
**9. Does the language you use matter?**

Kind of, it depends on what you're doing. If you need hyper-fast arithmetic, use C or C++. If you're doing anything web-related, then JavaScript is, and will always be, the industry standard -- you should definitely learn JavaScript at some point if you're a CSE major, you're going to need it. Python/Java can be used for everything else, though Java is mostly being phased out in favor of Python. 

If you're interested in data science and/or machine learning, Python is usually the industry language. You'll occasionally hear about R. 
...
**13. What code editor do you use?**

[Visual Studio Code](https://code.visualstudio.com) by Microsoft. 

**14. How do you type so fast?**

Too much time spent writing essays in an IB high school. 

**15. Where can I apply to become a ULA for a CSE course?**
...
**16. Do you need a 4.0 to become a ULA for this class?**
...
**17. Do you need to be a CSE major to become a ULA for this class?**
