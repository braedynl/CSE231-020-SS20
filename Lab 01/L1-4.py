...
# We have to cast our input from console to int in order to use our mathematical operations
number = int(number)
...
returned value. This is a topic we'll be getting into at a later date.
'''