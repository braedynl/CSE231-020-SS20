# Lab10b - Example Answer (Documented)
# Braedyn Lettinga
...
# I start out by creating a global list
# that represents both player's hands.
# I would read through starting from main()
hand1 = []
hand2 = []
...
def main():
    ...
    while True:
        ...
        # After each battle, we print off the player's hands
        print("hand1:", hand1)
        print("hand2:", hand2)

        # If either player's hands are empty, that means the opposing player
        # wins the game. We can check if a list is empty like this: `== []`
        if hand1 == []:
            print("Player 2 wins!!!")
            break    # The loop discontinues in the case that a player wins
        elif hand2 == []:
            print("Player 1 wins!!!")
            break
