        ...
        if continent != "":
            ...
            if country != "":
                if country not in data_map[continent].keys():
                    data_map[continent][country] = set()  # from part a, changed to set() instead of list()
            ...
            for continent in data_map:
                if country in data_map[continent]:
                    ...
                    if city not in data_map[continent][country]:
                        data_map[continent][country].add(city)  # from part a, changed to .add() instead of .append()
